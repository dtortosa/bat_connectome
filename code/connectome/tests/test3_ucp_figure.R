...
compare_distributions = function(seed){
    ...
    #save the results
    save.image("/Users/diegosalazar/Google Drive/science/open_projects/connectome/results/connectome_results/test3_ucp_figure.RData")
}
...
foreach(seed = seed) %dopar% { 
    compare_distributions(seed = seed)
} 
