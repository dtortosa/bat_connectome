#test if number of the known BAT genes include in BAT connectome is higher than expected by chance. 
...
### save results
write.table(results, "/Users/diegosalazar/Google Drive/science/open_projects/connectome/results/connectome_results/tests/test_4/results_test_4.txt", col.names = FALSE, row.names = FALSE, sep="\t")
